...
/**
 * Process bulk results and categorize
 */
export function categorizeBulkResults(results) {
  const categorized = {
    send: [],           // Valid mobile numbers, ready to check iOS
    unsubscribe: [],    // Deactivated/invalid numbers
    blacklist: [],      // Blacklisted/litigators
    error: []           // Errors
  };
  ...
  results.forEach((result, index) => {
    ...
    switch (result.action) {
      case 'send':
        // Only mobile numbers should be checked for iOS
