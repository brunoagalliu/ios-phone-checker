  ...
  try {
    ...
    try {
      ...
      phones.forEach(phone => {
        const cached = cacheResults && cacheResults[phone.e164];
        
        if (cached && typeof cached === 'object' && cached.is_ios !== undefined) {
          cachedPhones.push({
      ...
      console.error('Cache error, treating all as uncached:', cacheError.message);
